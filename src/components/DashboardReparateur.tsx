              ...
              {quickActions.map((action) => {
                ...
                return (
                  <button
                    ...
                    className="w-full md:aspect-auto rounded-lg transition-all duration-[250ms] group focus-visible:outline-2 focus-visible:outline-[#002f6b] focus-visible:outline-offset-2 active:scale-95 md:active:scale-100"
                  >
